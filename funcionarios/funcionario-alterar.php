...
$codigo_funcionario=mysqli_real_escape_String($conexao,$_POST['codigo_funcionario']);
...
inserirFuncionario($conexao,$codigo_funcionario,$nome_completo,$numero_rg,$emissor,$numero_cpf,$cep,$endereco,$numero,$bairro,$cidade,$estado,$celular,$email,$data_nascimento);
header("Location:funcionario-alterar.php");
}
?>
...
<div>
    ...
    <input type="text" name="codigo_funcionario" id="codigo">
</div>
<div>
